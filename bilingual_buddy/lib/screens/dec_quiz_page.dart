                ...
                child: Stack(
                  children: [
                    ...
                    buttonText(shuffledAnswers[0], () => checkAnswer(0),
                        x: 0.85, y: -0.025, width: 400, height: 156, fontSize: 48, backColor: tfButtonColor),
                    buttonText(shuffledAnswers[1], () => checkAnswer(1),
                        x: 0.85, y: 0.575, width: 400, height: 156, fontSize: 48, backColor: tfButtonColor),
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    buttonText(shuffledAnswers[0], () => checkAnswer(0),
                        x: 0.85, y: -0.35, width: 400, height: 156, fontSize: 48, backColor: mcqButtonColor),
                    buttonText(shuffledAnswers[1], () => checkAnswer(1),
                        x: 0.85, y: 0.25, width: 400, height: 156, fontSize: 48, backColor: mcqButtonColor),
                    buttonText(shuffledAnswers[2], () => checkAnswer(2),
                        x: 0.85, y: 0.85, width: 400, height: 156, fontSize: 48, backColor: mcqButtonColor),
                    DecimalsFlipCardQuizCard(question: widget.question),
                  ],
                ),
              ),
                ...
                child: Stack(
                  children: [
                    ...
                    boxText(widget.question.question,
                        x: 0.0, y: -0.05, width: 1133, height: 412, backColor: txtQuestionColor),
                    boxInput(input, "Type Answer",
                        x: -0.7, y: 0.85, width: 784, height: 100, backColor: txtButtonColor),
