                ...
                child: Stack(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        buttonText('1', () => quiz([
                            MCQ("How do you write 2.3 in English?", ["Two Point Three", "Two Comma Three", "Two and Three"], 0, "¿Cómo se escribe 2.3 en inglés?"), 
                            TF("The decimal 0.75 is said as 'Zero Point Seventy-Five' in English.", ["True", "False"], 1, "El decimal 0,75 se dice 'cero punto setenta y cinco' en inglés."), 
                            TXT("How do you say 5.6 in English?", "Five Point Six", "¿Cómo se dice 5.6 en inglés?"), 
                            MCQ("Which is the correct way to say 0.4 in English?", ["Zero Four", "Zero Point Four", "Four Tenth"], 1, "¿Cuál es la forma correcta de decir 0.4 en inglés?"),
                          ], 1), 
                        ...
                        buttonText('2', () => quiz([
                            TF("In English, 3.14 is said as 'Three Point One Four'.", ["True", "False"], 0, "En inglés, 3.14 se dice como 'tres punto uno cuatro'."),
                            MCQ("How do you write 0.08 in English?", ["Zero Point Eight", "Eight Hundredths", "Zero Point Zero Eight"], 2, "¿Cómo se escribe 0.08 en inglés?"),
                            TXT("How do you say 10.5 in English?", "Ten Point Five", "¿Cómo se dice 10.5 en inglés?"),
                            MCQ("Which is correct for 7.07?", ["Seven Point Zero Seven", "Seven Point Seven", "Seven Zero Seven"], 0, "¿Cuál es correcto para 7.07?"),
                          ], 2), 
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        buttonText(
                          '1',
                          () => lessonPage("assets/lessons/decimal_lesson.pdf", 1),
                          x: 0.0,
                          y: -0.3,
                          width: 310,
                          height: 270,
                        ...
                        buttonText('2', () => lessonPage("assets/lessons/Decimal_Lesson2.pdf", 2),
                            x: 0.0, y: -0.3, width: 310, height: 270, fontSize: 128),
                        buttonText('3', () => lessonPage("assets/lessons/Decimal_Lesson2.pdf", 3),
                            x: 0.0, y: -0.3, width: 310, height: 270, fontSize: 128),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        buttonText('4', () => lessonPage("assets/lessons/Decimal_Lesson4.pdf", 4),
                            x: 0.0, y: 0.85, width: 310, height: 270, fontSize: 128),
                        buttonText('5', () => lessonPage("assets/lessons/Decimal_Lesson5.pdf", 5),
                            x: 0.0, y: 0.85, width: 310, height: 270, fontSize: 128),
                        buttonText('6',  () => lessonPage("assets/lessons/Decimal_Lesson6.pdf", 6),
                            x: 0.0, y: 0.85, width: 310, height: 270, fontSize: 128),
                      ],
                    ),
                  ],
